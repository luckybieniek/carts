...
const UserSchedule = ({
    ...
    const currentTextContent = textContent[language].user_schedule;
    useEffect(() => {}, [language]);
    ...
    const slotModalContent = (
        <div className="modal_content">
            ...
            <div className="modal_body">
                <p>{currentTextContent.modal_content.publishers_assigned}</p>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {timeSlots.map((slot) => {
                                        ...
                                        const isPublisherOnShift =
                                            publishersOnShift.find(
                                                (asssignedPub) =>
                                                    asssignedPub.user_id ===
                                                    loggedUser.id
                                            );

                                        if (
                                            isPublisherOnShift &&
                                            publishersOnShift.length === 1
                                        ) {
                                            slotColor = 2;
                                        } else if (
                                            isPublisherOnShift &&
                                            publishersOnShift.length >= 2
                                        ) {
                                            slotColor = 1;
                                        } else {
                                            null;
                                        ...
                                        return slotColor !== null
                                            ? slot.day === availableDay && (
                                                  <ShiftCard
                                                      ...
                                                      shiftCardDataContent="userSchedule"
                                                  />
                                              )
                                            : null;
                                    })}
